var base_url = "www.elybaden.co.kr";
var base_url2 = "elybaden.co.kr";
...
var pay = {
	...
	prev_nlogin2: function(total_m, add_val) {
		...
		$("#rform").attr("action", "http://www."+base_url2+"/reservation/preserve_nlogin.php?md=WQwlVQ=="+add_val);
		$("#rform").submit();
	},
